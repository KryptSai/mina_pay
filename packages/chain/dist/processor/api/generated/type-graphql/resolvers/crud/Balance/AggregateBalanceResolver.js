...
let AggregateBalanceResolver = class AggregateBalanceResolver {
...
], AggregateBalanceResolver.prototype, "aggregateBalance", null);
AggregateBalanceResolver = __decorate([
    TypeGraphQL.Resolver(_of => Balance)
], AggregateBalanceResolver);
export { AggregateBalanceResolver };
