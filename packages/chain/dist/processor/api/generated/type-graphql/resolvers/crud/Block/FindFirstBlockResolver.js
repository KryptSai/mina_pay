...
let FindFirstBlockResolver = class FindFirstBlockResolver {
...
], FindFirstBlockResolver.prototype, "findFirstBlock", null);
FindFirstBlockResolver = __decorate([
    TypeGraphQL.Resolver(_of => Block)
], FindFirstBlockResolver);
export { FindFirstBlockResolver };
