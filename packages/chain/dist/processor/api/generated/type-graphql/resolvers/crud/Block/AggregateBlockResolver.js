...
let AggregateBlockResolver = class AggregateBlockResolver {
...
], AggregateBlockResolver.prototype, "aggregateBlock", null);
AggregateBlockResolver = __decorate([
    TypeGraphQL.Resolver(_of => Block)
], AggregateBlockResolver);
export { AggregateBlockResolver };
