...
let FindUniqueBalanceResolver = class FindUniqueBalanceResolver {
...
], FindUniqueBalanceResolver.prototype, "balance", null);
FindUniqueBalanceResolver = __decorate([
    TypeGraphQL.Resolver(_of => Balance)
], FindUniqueBalanceResolver);
export { FindUniqueBalanceResolver };
